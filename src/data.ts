  ...
  en: [
    {
      ...
      shortStory: "We designed and built an e commerce website for our client, enabling them to launch their brand online with a secure payment setup and clean user interface.",
      technologies: ["Next.js", "PostgreSQL", "TailwindCSS", "Vercel"],
      timeline: "3 Weeks",
