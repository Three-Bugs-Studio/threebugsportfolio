        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16 pb-16 border-b border-white/5">
          ...
          <div className="lg:col-span-3 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              {/* User Requested Split Social Card */}
              <div className="social-split-card interactive">
                <span>SOCIAL</span>
                {/* GitHub Link */}
                <a className="social-link" href="https://github.com/Three-Bugs-Studio" target="_blank" rel="noreferrer" title="GitHub">
                ...
                {/* Discord Link */}
                <a className="social-link" href="https://discord.gg/WDfhFdtqwv" target="_blank" rel="noreferrer" title="Discord">
                  <svg viewBox="0 0 24 24">
                ...
                {/* Email Link */}
                <a className="social-link" href="mailto:dongduong840@gmail.com" title="Email Direct">
                  <svg viewBox="0 0 24 24">
                    <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                  </svg>
                </a>
                {/* Contact Inquiries Link */}
                <a className="social-link" href="#app-contact-section" title="Inquiry Form">
                  <svg viewBox="0 0 24 24">
